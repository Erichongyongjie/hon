...
$title = "小高教学网音乐试听外链站www.xx8g.com";//网站标题
$lxfs = "http://www.weifenshi.com";//网站底部联系方式
...
function mv(){
	...
	$output .= "</ul></div></div><div class=\"main\"><a href=\"http://www.xx8g.com\" target=\"_blank\"><img width=\"910\" src=\"https://i.loli.net/2017/09/25/59c8f1c0f3949.gif\"></a></div>";
return $output;
}
//首页歌曲
function bang(){
...
function song_lrc($id){
	...
	$output = "<a href=\"https://www.dhw22.com\" target=\"_blank\"><img src=\"http://tva1.sinaimg.cn/mw690/6b229b76jw1f8qfzhnmvrj20jg0jgdpf.jpg\" width=\"280px\" height=\"200px\"/></a>";
	}
return $output;
}
//大小转换//
...
<div class="header">
	<div class="h_main">
		...
		<ul class="member">
		<li><a class="seh_a seh_c" href="javascript:void(0)" id="img">图片外链</a></li>
		</ul>
	</div>
</div>
<!-- toper End -->
...
<p><script language="javascript">var datatime=new Date(); document.write("&copy; 2010-"+datatime.getFullYear()+".");</script> 音乐试听网 <?php echo $lxfs;?> <a target="_blank" href="http://www.xx8g.com">推荐：小高教学网</a> 丨 <a target="_blank" href="http://www.weifenshi.com/">淘宝内部省钱APP限量注册</a></p>
<p><a href="http://www.xx8g.com" target="_blank"><img src="http://downlink.sinaapp.com/117X12px.gif" title="本站由新浪云SAE提供云计算支持！"/></a></p>
<p style='display:none'>
<!-- tongji Start 统计代码 -->
<script src="http://www.144g.com/js/statistics.js"></script>
<!-- tongji End -->
</p>
</div>
<!-- bottom End -->
